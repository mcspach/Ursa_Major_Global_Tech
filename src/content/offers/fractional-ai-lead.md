...
process:
  - step: Embed
    detail: First two weeks inside the codebase and the operation. We map what exists, fix the quick wins, and calibrate what a month of real velocity looks like here.
...
Hiring for that is hard, because most companies can't yet write the job spec.
This is that role, rented, with a three-month floor so there's time for the work
to compound.

Half the fee from a preceding [Strategy Engagement](/advisory/ai-strategy-engagement/)
credits against the first two months.
