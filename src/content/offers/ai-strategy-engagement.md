...
exitArtifact: A priced implementation proposal with a start date, delivered within five business days of the readout.
...
scope:
  ...
  - label: Revision rounds
    value: 2, consolidated feedback only
  - label: Document review
    value: Up to 40 documents you provide
  - label: Systems reviewed
    value: Up to 8
  - label: Business units
    value: 1
  - label: Engagement window
    value: 5 weeks from kickoff, expiring at 7 weeks regardless of delay
...
addOns:
  - label: Additional stakeholder interview
    amount: 750
  - label: Additional workshop (half day)
    amount: 2500
  - label: Additional executive readout
    amount: 2500
  - label: Additional revision round beyond 2
    amount: 2000
  - label: Additional business unit in scope
    amount: 6000
  - label: Board-level presentation with rehearsal
    amount: 3500
  - label: Written vendor comparison, per category
    amount: 2500
  - label: On-site delivery, per day
    amount: 2500
    note: plus travel
...
The [Audit](/advisory/ai-opportunity-audit/) works bottom-up: it maps processes
and prices automations. This works top-down. It maps capability, org design,
governance, and sequencing, and it produces a number your CFO can defend.

What you're buying is not a document. It's **a decision you can take to a board,
and a sequence you can fund.**

## The gate before we start

No work begins until one sentence is written down and confirmed by the sponsor:
...
item rather than becoming an argument later.

## On the numbers

The investment model ships as a live spreadsheet, not a static table in a PDF.
Every projected effect is a range with a stated confidence rating, plus a
sensitivity case at half the expected adoption.

**No single-point ROI numbers.** Ranges with stated confidence survive CFO
scrutiny; point estimates invite one question nobody can answer. Every baseline
is confirmed with you before it enters the model, because a number you dispute at
the readout costs more than a number we left out.
