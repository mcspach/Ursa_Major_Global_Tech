...
deliverables:
  - Two scheduled sessions per month, 60 minutes, with the agenda set by you
...
exclusions:
  - No builds, integrations, or configuration
  - No written deliverables or documentation
  - No guaranteed response time on async questions
  - No sessions carried over between months
---

## What this is for

The most common way a good engagement ends badly is that it just… ends. The
heavy lift finishes, the team takes over, and six months later a decision gets
made without the context that was built up over the previous year.

This is the floor under that. Two sessions a month is enough to keep the thread
